...
class Track:
    ...
    def get_cover_thumbnail(self, meme: bool, img_quality: ImageQuality) -> bytes:
        """
        ...
        cover_bytes = self.get_cover(meme)
        ...
        if cover_bytes:
            ...
            log.warning('No thumbnail, using fallback')
            input_path = Path('app', 'static', 'img', 'raphson.png')
